  ...
  return (
    <View style={styles.container} data-test="container">
      <ImageBackground
        source={{
          uri:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwTRIb_53hqrRIMS1Kcux4Zjf7LiafMqRibQ&usqp=CAU",
        }}
        style={{
          flex: 1,
      ...
      >
        ...
        >
          <Animatable.Text animation="bounceInLeft" style={styles.headingText}>
            अध्ययनतंत्रांश
          </Animatable.Text>
